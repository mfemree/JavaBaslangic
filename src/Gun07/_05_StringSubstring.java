...
public class _05_StringSubstring {
    ...
    String s1 = "Merhaba arkadaslar";
        ...
        String parca1= s1.substring(3,9); // 3 nolu indexten 9 nolu indexe kadar alir, 9 nolu index dahil.
        System.out.println("parca1 = " + parca1);

        String parca2= s1.substring(8,15); // 3 nolu indexten 9 nolu indexe kadar alir, 9 nolu index dahil.
