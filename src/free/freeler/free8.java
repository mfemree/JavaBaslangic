...
public class free8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("round(yuvarlama) 3.1 = " + Math.round(3.2));  // 3    , 3.5 dan az ise asagiya yuvarlar
        System.out.println("round(yuvarlama) 3.5 = " + Math.round(3.5));  // 4    , 3.5 ve 3.5 dan fazla ise yukariya yuvarlar
